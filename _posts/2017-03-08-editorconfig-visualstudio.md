---
layout: post
title: Vos configurations EditorConfig à même Visual Studio
modified: 2016-12-19
tags: [editorconfig, visual studio]
categories: [code]
...
Le concept d'[EditorConfig](http://editorconfig.org/) nous permet de garder les configurations du formatage directement dans le dépôt de code source. Cela devient donc extrêmement agréable de passer d'un projet à l'autre sans se soucier des normes de ceux-ci.
